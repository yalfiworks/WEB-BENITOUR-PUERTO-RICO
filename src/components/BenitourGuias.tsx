      ...
      <div className="bnt-guias__inner">
        <header className="bnt-guias__header">
          <h2 className="bnt-guias__h2" id="benitour-guias-title">
            Nuestros <em>Guías</em><br />
            <span>Locales</span>
          </h2>
          <p>Vecinos de Vega Baja que conocen cada esquina, cada historia y cada cara del barrio.</p>
        ...
        <div className="bnt-guias__hero">
          <Image
            ...
            alt="Edwin y Karla, guías locales de Benitour"
            fill
            priority
          ...
          <div className="bnt-guias__hero-content">
            <span>BENITOUR · VEGA BAJA, PR</span>
            <h3>
              Conoce a tu<br />
        ...
        <div className="bnt-guias__cta">
          <span>Grupo de 6 personas · 3 horas · Vega Baja, PR</span>
        </div>
      </div>
    </section>
  );
